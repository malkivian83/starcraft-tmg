...
function ArmyBuilderApp() {
  ...
  const confirmDiscard = (action: string) => page !== 'builder' || !isDirty || window.confirm(`${action} hará que se pierdan los cambios sin guardar de esta lista. ¿Quieres continuar?`);
